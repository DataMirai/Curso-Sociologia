...
```{r dataset, echo=TRUE}
education <- read.csv('/Users/mireiacamacho/Desktop/Curso-sociologia/Tidymodels_2/dataset-educacion.csv', sep=";") %>% 
  as.tibble()
...
- **¡No te compliques! Ponte creativo/a y explica cómo le sacarías partido a los datos a partir de un modelo predictivo.**
