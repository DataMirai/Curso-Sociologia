...
-   Línea de Datos: aprendizaje a Entrenamiento del modelo : Pre
    procesamiento
...
regresión se interpretan en términos de cambios porcentuales. **El
modelo se vuelve interpretable desde el punto de vista relativo y no
absoluto**. Esto es vital para tratar temas como el salario donde los
incremnetos relativos son mucho más válidos que los absolutos.

-   No es lo mismo incremenetar el salario 100€ a alguien que cobra
    1.000€ al mes que a alguien con 10.000€ al mes.
