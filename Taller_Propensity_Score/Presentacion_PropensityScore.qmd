...
## 1. Introducción al tipo de estudios {auto-animate="true"}
...
## 2. ¿Qué es el Machine Learning? {auto-animate="true"}
...
La clave del Machine Learning es el **sentido común**.


## {auto-animate="true"}

![](Imagenes/better_data_models.jpeg){width="300" fig-align="center"}

# Los modelos de Machine Learning resuelven problemas de clasificación o problemas de regresión. 


## 3. Tipos de diseño experimental {auto-animate="true"}

![](Imagenes/Piramide_tipos_diseñoExperimental.png){width="300" fig-align="center"}

## 3. Tipos de diseño experimental {auto-animate="true"}

Para poder hacer un estudio, sea el que sea, es necesario tener algo que comparar.
...
::: incremental
- **Estudios de Encuestas:** Recopilan datos a través de cuestionarios estructurados. Permiten estudiar la relación entre variables en una gran muestra de población.

- **Estudios de Caso:** Se centran en un individuo, grupo o evento específico para una observación profunda y detallada.

- **Estudios Longitudinales:** Observan a los mismos sujetos a lo largo de un período de tiempo extendido para ver cómo cambian las variables estudiadas.

- **Etnografías:** Involucran la observación participante y entrevistas para comprender las culturas y prácticas de grupos específicos.
...
::: incremental
- **Experimentos de Campo:** Los participantes no saben que están siendo observados para minimizar el sesgo. Por ejemplo, un experimento que mide la reacción de las personas a diferentes estímulos en un entorno laboral real.
...
::: incremental
- *P valor* es la probabilidad de que lo que hayas observado sea no aleatorio, asumiendo cierta la hipótesis nula de la cual partías.

- Tener un *P valor* de 0.05 viene a significar que la probabilidad de que lo que se está observando NO es aleatorio es solo del 5%.
:::
...
::: incremental
- No nos dicen NADA sobre la importancia clínica o científica. Sólo si los resultados se debieron o no al azar.
...
Tamaño de muestra
![](Imagenes/Tamaño de muestra.png){width="300" fig-align="center"}
...
::: incremental
- No todas las covariables tienen la misma importancia se seleccionarán únicamente aquellas que probablemente afecten al resultado.
...
1. Elegir qué variables deben estar equilibradas por población a nivel de azar.
2. Crear una tabla con *TableOne* para ver las *SMD* y su nivel basal.
3. Aplicar un algoritmo de clasificación para ver las propensiones (usaremos un **glm** para no complicarnos).
4. Crear la probabilidad de clasificación.
5. Crear una variable IPTW / matching según las necesidades.
6. Rehacer *TableOne* pero esta vez con los pesos o las variables de matching, y volver a las *SMD*.
7. Asegurar que los *SMD* de las variables del punto primero están por debajo de 0.1.
