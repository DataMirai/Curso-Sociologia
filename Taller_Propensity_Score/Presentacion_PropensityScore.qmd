...
Antes de lanzarte a hacer cualquier tipo de modelización, Ten un buen
diseño y minimiza confusión.
...
No se puede obtener un modelo que sea "verdadero", por muy elaborado que lo haya hecho.
...
![](Imagenes/hznah1jzh8fa1111111.png)
...
Para poder hacer un cualquier estudio, es necesario tener algo un objetivo, normalmente algo con lo que comparar.
...
-   **Estudios transversales:** Recopilan datos a través de cuestionarios
    estructurados. Permiten estudiar la relación entre variables en una
    gran muestra de población.

-   **Estudios de cohorte:** Observan a los mismos sujetos a lo
    largo de un período de tiempo extendido para ver cómo cambian las
...
-   **Experimentos de Campo:** Los participantes no saben que están
    siendo observados. Por ejemplo, un
    experimento que mide la reacción de las personas a diferentes
    estímulos en un entorno laboral real.
...
-   *P valor* es la probabilidad de que lo que hayas observado sea no
    aleatorio, asumiendo cierta la hipótesis nula de la cual partías.

-   Tener un *P valor* de 0.05 viene a significar que la probabilidad de
    que lo que se está observando NO es aleatorio es solo del 5%.
:::

## 4.1. Puntos débiles de los *P valores* {auto-animate="true"}

::: incremental
-   No nos dicen NADA sobre la importancia clínica o científica. Sólo si
    los resultados se debieron o no al azar.
