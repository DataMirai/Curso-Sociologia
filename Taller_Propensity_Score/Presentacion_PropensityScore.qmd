...
-   **No hay un modelo mejor que otro**: cada situación requerirá de
    ...
    -   Los **Random Forest** son geniales porque pueden lidiar con
        patrones muy difíciles, pero olvídate de
:::
...
![](Imagenes/hznah1jzh8fa1111111.png){fig-align="center" width="320"}
...
- Para poder hacer cualquier estudio, es necesario tener un
...
<div style="font-size:55px; margin-top:70px; text-align:center;">
...
## 4.1.1. Conocimiento previo/experto: Caso Punga {auto-animate="true"}
...
# Lo que punga hizo:
PIB_datos %>% 
  mutate(Desviacion_Punga = sqrt((PIBxC - mean(PIBxC))^2)/n() )
...
1.  No se tuvo en cuenta el factor de inflación, Demasiada poca
    desviación.
2.  Desviacion no es necesariamente tiene que ser negativo, puede
    deberse a crecimiento económico.
3.  Incluso dentro de un periodo, los subperiodos contienen información.

**NUNCA JAMÄS ignorar la descriptiva, jugar con ella es demasiado
valioso**
...
## 4.1.1. Dependencias de los *P valores*? {auto-animate="true"}

Diferencias de medias

![](Imagenes/diferencias_medias.png){width="300" fig-align="center"}

## 4.1.2. Dependencias de los *P valores*? {auto-animate="true"}

Dispersión ![](Imagenes/Dispersión.png){width="300" fig-align="center"}

## 4.1.3. Dependencias de los *P valores*? {auto-animate="true"}
...
estandarizadas son básicamente la diferencia de entre las medias o
