...
## 4. Conocimiento previo/experto {auto-animate="true"}
...
El conocimiento del experto tiene que ser reforzado, pero en muchas ocasiones es mejor reforzarlo usando un modelo bien fundamentado. 

_______________

1. No se tuvo en cuenta el factor de inflación, Demasiada poca desviación.
2. Desviacion no es necesariamente tiene que ser negativo, puede deberse a crecimiento económico.
